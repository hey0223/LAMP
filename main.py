...
def parse_args():
    ...
    parser.add_argument("--alg", type=str, default='maddpg', help="maddpg")
...
if __name__ == '__main__':
    ...
    try:
        ...
        logger.info(f"Seed={yaml_cfg.seed}")
        logger.info(
            f"Training plan -> epochs={yaml_cfg.Trainer['n_epochs']}, "
            f"epoch_length={yaml_cfg.Trainer['epoch_length']}, "
            f"batch_size={args.batch_size}, "
            f"total_steps={yaml_cfg.Trainer['n_epochs'] * yaml_cfg.Trainer['epoch_length']}"
        )
